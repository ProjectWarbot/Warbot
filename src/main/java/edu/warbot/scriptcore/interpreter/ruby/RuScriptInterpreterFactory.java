package edu.warbot.scriptcore.interpreter.ruby;
...
public class RuScriptInterpreterFactory extends ScriptInterpreterFactory{

	public RuScriptInterpreterFactory() {
